...
- `writes.py`: write session with SQL planning and execution; helpers for common relationships.
- `scripts/*`: focused CLIs for each function; `sql_preview.py` as the write front-door.
