...
- `LIVE-WRITE-COMPATIBILITY.md`: Versioned observations and required discovery steps for direct writes to the live iCloud store.
...
- `DB-SCHEMA.md` is a generated test-store snapshot. Treat a live iCloud store as a separate versioned schema profile and consult `LIVE-WRITE-COMPATIBILITY.md` before designing direct writes.
